...
import { HomeSection, SearchRequest, Manga, Request, Chapter, ChapterDetails, HomeSectionRequest, TagSection, SourceTag, MangaUpdates } from "..";
...
export declare abstract class Source {
    ...
    getCloudflareBypassRequest(): Request | null;
    /**
